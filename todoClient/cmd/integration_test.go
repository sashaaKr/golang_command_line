...
// // Run tests only if it was executed with '-tags integration'
// package cmd
...
// 	var p strings.Builder
// 	for i := 0; i < 32; i++ {
// 		p.WriteByte(chanrs[r.Intn(len(chanrs))])
// 	}
...
// 		if outList == "" {
// 			t.Errorf("Task %q not found in the list", task)
// 		}

// 		// if outList != "not" {
// 		// 	t.Errorf("outlist %q", outList)
// 		// }
...
// 		taskId = strings.Fields(outList)[1]
// 		if taskId == "aaaa" {
// 			t.Errorf("Expected task id to be a number, got %q", taskId)
// 		}
// 	})
...
// 		if !strings.Contains(viewOut[1], today) {
// 			t.Fatalf("Expected date %q, got %q", today, viewOut[1])
// 		}

// 		if !strings.Contains(viewOut[2], "No") {
// 			t.Fatalf("Expected status %q, got %q", "No", viewOut[2])
// 		}
// 	})

// 	if !vRes {
// 		t.Fatalf("View task failed")
// 	}

// 	t.Run("CompleteTask", func(t *testing.T) {
// 		var out bytes.Buffer
// 		if err := completeAction(&out, apiRoot, "1"); err != nil {
// 			t.Fatalf("Expected no error, got %q", err)
// 		}
...
// 		if outList == "" {
// 			t.Errorf("Task %q not found in the list %q", task, out.String())
// 		}

// 		taskCompletedStatus := strings.Fields(outList)[0]

// 		if taskCompletedStatus != "X" {
// 			t.Errorf("Expected status %q, got %q", "X", taskCompletedStatus)
// 		}
// 	})

// 	t.Run("DeleteTask", func(t *testing.T) {
// 		var out bytes.Buffer
// 		if err := deleteAction(&out, apiRoot, "1"); err != nil {
// 			t.Fatalf("Expected no error, got %q", err)
// 		}
...
// 		for scanner.Scan() {
// 			if strings.Contains(scanner.Text(), task) {
// 				t.Errorf("Task %q still found in the list", task)
// 				break
// 			}
// 		}
// 	})
