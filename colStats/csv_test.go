...
func TestOperations(t *testing.T) {
	...
	testCases := []struct {
		...
		{"Sum", sum, []float64{300, 87.727000, -30, 436}},
		{"Avg", avg, []float64{37.5, 6.266214, -15, 72.666667}},
	}
...
`
	testCases := []struct {
		...
		{ name: "FailedInvalidColumnn", col: 4, exp: nil, expErr: ErrInvalidColumn, r: bytes.NewBufferString(csvData) },
	}
