...
func Testrun(t *testing.T) {
	testCases := []struct {
		...
		{ name: "RunAvgMultiFiles", col: 3, op: "avg", files: []string{"./testdata/example.csv", "./testdata/example2.csv"}, expErr: nil },
		{ name: "RunFaileRead", col: 2, op: "avg", files: []string{"./testdata/example.csv", "./testdata/fakefile.csv"}, expErr: os.ErrNotExist },
		...
		{ name: "RunFailOperation", col: 2, op: "fake", exp: "", files: []string{"./testdata/example.csv"}, expErr: ErrInvalidOperation },
	}
